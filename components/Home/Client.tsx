      ...
      <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <div className="w-24 h-24 rounded-full bg-gray-50 flex items-center justify-center p-4 border border-gray-100 group-hover:border-gray-200 transition-all">
                    <img
                      src={client.logo}
                      alt={client.name}
                      className="max-w-full max-h-full object-contain md:grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
                    />
                  </div>
        ...
        <div className="mt-20 text-center max-w-2xl mx-auto">
          ...
          <blockquote className="text-xl lg:text-2xl text-gray-600 font-light leading-relaxed">
            "He demonstrated strong technical skills, professionalism, and the
            ability to deliver quality work within deadlines. He worked well
            with the team and contributed positively to our projects. "
          </blockquote>
          <div className="mt-6">
            <a
              href="https://www.linkedin.com/in/gbenga-johnson-846261156/"
              target="_blank"
            ...
            <p className="text-sm text-gray-400 font-mono">
              Entrepreneur | Digital Transformation Leader | Agile Project
              Manager | Strategic Innovator
            </p>
