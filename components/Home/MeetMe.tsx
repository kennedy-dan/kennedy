  ...
  return (
    <section className="bg-white py-24 px-6 lg:px-12 border-t border-gray-100">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Main Content */}
        <div className="grid lg:grid-cols-2 md:grayscale md:hover:grayscale-0 transition-all duration-700 gap-16 lg:gap-24 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 p-8 space-y-4">
              <h4 className="text-xs font-mono text-gray-500 tracking-wider">
                CURRENT FOCUS
              </h4>
              <div className="space-y-3">
            ...
            <div className="flex gap-6 pt-4">
              <SocialLink
                href="https://github.com/kennedy-dan"
                label="GitHub"
              />
              <SocialLink
