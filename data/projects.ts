...
},
{
  ...
  overviewThumbnail: {
    url: "/images/myartstockpreview.png"
  },
  overviewLinks: {
  ...
  testimonial: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
  extraImages: [
    { url: "/images/myartmore.png" },
    { url: "/images/myartmore1.png" },
    { url: "/images/myartmore2.png" },
    { url: "/images/myartmore3.png" },
  ],
  problems: {
  ...
  accessibility: {
    ...
    images: [
        { url: "/images/mobileart3.PNG" },
      { url: "/images/mobileart4.PNG" },
      { url: "/images/mobileart.PNG" },
      { url: "/images/mobileart2.PNG" },
...
},
{
  ...
  testimonial: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
  extraImages: [
    { url: "/images/moreimgclov.PNG" },
    { url: "/images/moreimgclove2.PNG" },
  ],
  problems: {
...
},
{
  ...
  testimonial: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
  extraImages: [
    { url: "/images/dineextra.png" },
    { url: "/images/dineextra2.png" }
  ],
  problems: {
  ...
  accessibility: {
    ...
    images: [
      { url: "/images/mobiledine.png" },
      { url: "/images/mobiledine2.png" }
    ]
  },
